...
import { buyproperty } from '../services/allapi';
...
function Payment() {
  ...
  const handlebuy = async () => {
    ...
    if (token) {
      ...
      try {
        await buyproperty(reqBody, reqHeader);
        Swal.fire({
        ...
        <div className="col-lg-7 pb-5 pe-lg-5">
          <div className="row">
            ...
            <div className="col-md-4 col-6 ps-3 pe-0 my-4">
                ...
                <p className="h5">{property ? `${property.Price} ` : 'N/A'}</p>
              </div>
              <div className="col-md-4 col-6 ps-3 my-4">
                <p className="text-muted">Address</p>
                <p className="h5 m-0">{property ? property.address : 'N/A'}</p>
              </div>
              <div className="col-md-4 col-6 ps-3 my-4">
                <p className="text-muted">Type</p>
                <p className="h5 m-0">{property ? property.type : 'N/A'}</p>
              </div>
              <div className="col-md-4 col-6 ps-3 my-4">
                <p className="text-muted">Floors</p>
                <p className="h5 m-0">{property ? property.floors : 'N/A'}</p>
              </div>
              <div className="col-md-4 col-6 ps-3 my-4">
                <p className="text-muted">Furnishing</p>
                <p className="h5 m-0">{property ? property.furnishing : 'N/A'}</p>
              </div>
              <div className="col-md-4 col-6 ps-3 my-4">
                <p className="text-muted">CarParking</p>
                <p className="h5 m-0">{property ? property.carparking : 'N/A'}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row m-0">
            ...
            <div className="d-flex align-items-end mt-2 mb-2"></div>
              <div className="d-flex justify-content-between mb-2">
                ...
                <p className="fs-14 fw-bold">{property ? property.place : 'n/a'}</p>
              </div>
              <div className="d-flex justify-content-between mb-2">
                    ...
                    <span className="me-5">
                      ...
                      <div className="row m-0">
                        <div className="col-12  mb-3 p-0">
                          <button style={{marginTop:"120%"}} onClick={handleCancel} className="btn btn-danger">
                            cancel
                          </button>
                        </div>
                      </div>
