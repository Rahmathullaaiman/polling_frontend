...
import {  adduserproperties } from '../services/allapi';
    ...
    useEffect(()=>{
     ...
     const addproperty =async (e)=>{
      ...
      if(token){ 
        ...
        const result =  await adduserproperties(reqBody,reqHeader)
        console.log(result);
    ...
    return (
      ...
      <div className="container mt-5">
        ...
        <Row>
          ...
          <button onClick={addproperty} type="submit" className="btn btn-success">
            SUBMIT
          </button>
               </div>
