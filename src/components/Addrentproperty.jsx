...
import { Addrentproperties } from '../services/allapi';
  ...
  useEffect(()=>{
   ...
   const addrentproperty =async (e)=>{
    ...
    if(token){ 
      ...
      const result =  await Addrentproperties(reqBody,reqHeader)
      console.log(result);
  ...
  return (
    ...
    <div className="container mt-5">
      ...
      <Row>
        ...
        <button onClick={addrentproperty}  type="submit" className="btn btn-success">
          SUBMIT
        </button>
             </div>
