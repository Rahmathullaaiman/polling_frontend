...
function Sidebar({ sidebarOpen, setSidebarOpen, user, setShowModal }) {
  return (
    <div
      style={{
        ...
        alignItems: "center",
        padding: sidebarOpen ? "40px 0" : "20px 0",
    ...
    >
      ...
      <div
        style={{
          ...
          flexDirection: "column",
          alignItems: "center",
          marginBottom: sidebarOpen ? "40px" : "0",
          width: "100%",
        }}
      >
        {user?.username ? (
          <img
            ...
            alt="User Avatar"
            style={{
              width: sidebarOpen ? "64px" : "32px",
              height: sidebarOpen ? "64px" : "32px",
              borderRadius: "50%",
              objectFit: "cover",
          ...
          <i
            className={`bi bi-person-circle ${sidebarOpen ? "fs-1" : "fs-3"
              } text-dark mb-2`}
          ></i>
        )}
        {sidebarOpen && (
          <span
            className="fw-bold"
            style={{ fontSize: "18px", color: "#1a237e" }}
          >
            {user?.username || "User"}
          </span>
        )}
      ...
      {sidebarOpen && (
        <Button
          variant="danger"
          className="fw-bolder mt-auto mb-2 w-75"
          onClick={() => {
